...
import {
  POSTS_ERROR, POSTS_HIDE, POSTS_LOAD, POSTS_SHOW, POSTS_SUCCESS, POSTS_USER,
...
const postsReducer = (state = initialState, action: PostsAction) => produce(state, (draft: PostListState) => {
  switch (action.type) {
    case POSTS_SHOW:
