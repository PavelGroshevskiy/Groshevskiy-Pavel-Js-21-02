...
export const getDefaultPageSize = (prefix: string = ''): number =>
  parseInt(localStorage.getItem(prefix.concat('/', STORAGE_PAGE_SIZE_KEY)) || '20', 10);
export const setDefaultPageSize = (pageSize: number, prefix: string = ''): void =>
  localStorage.setItem(prefix.concat('/', STORAGE_PAGE_SIZE_KEY), pageSize.toString());
...
export const disabledDate = (d: Moment): boolean =>
